...
function describeWeather(code) {
  const WEATHER_CODES = { 0:"Grand soleil",1:"Ciel dégagé",2:"Éclaircies",3:"Ciel couvert",45:"Brouillard",48:"Brouillard givrant",61:"Pluie faible",63:"Pluie",65:"Pluie forte",80:"Averses",95:"Orages" };
...
document.addEventListener("DOMContentLoaded", async () => {
  setClock();
  await Promise.allSettled([refreshWeather(), refreshSaint(), refreshNews()]);
  updateTicker();
  setLastUpdate();
  startLoops();
});